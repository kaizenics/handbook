            ...
            <div className="flex relative justify-center items-center ">
              <div className="mt-8">
                ...
                <div className="flex space-x-3 justify-end">
                  ...
                  <VscSparkleFilled className="text-blue-700 w-[45px] h-[45px]" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 my-4">
              <div className="relative w-[400px] h-[400px] bg-white border border-gray-300 shadow-xl rounded-md">
                <div className="flex justify-center items-center my-5 mx-auto">
                  <IoMdChatbubbles className="w-[80px] h-[80px] text-red-700" />
                </div>
                <div className="font-inter">
                  <h1 className="px-3 text-red-700 text-2xl text-center font-bold">
                  ...
                  <p className="px-3 py-4 text-black text-lg text-center font-regular">
                    ...
                    frequently asked questions (FAQs) from students. This could
                    provide 24/7 support for basic inquiries about course
                    registration, administrative processes, or campus resources,
                    freeing up human staff to handle more complex issues.
                  </p>
                </div>
              </div>
              <div className="relative w-[400px] h-[400px] bg-white border border-gray-300 shadow-xl rounded-md">
                <div className="flex justify-center items-center my-5 mx-auto">
                  <GoCodeOfConduct className="w-[80px] h-[80px] text-red-700" />
                </div>
                <div className="font-inter">
                  <h1 className="px-3 text-red-700 text-2xl text-center font-bold">
                  ...
                  <p className="px-3 py-4 text-black text-lg text-center font-regular">
                    ...
                    outlines the expectations for student behavior at Holy Cross
                    of Davao College (HCDC). It aims to foster a safe,
              ...
              <div className="relative w-[400px] h-[400px] bg-white border border-gray-300 shadow-xl rounded-md">
                <div className="flex justify-center items-center my-5 mx-auto">
                  <MdPolicy className="w-[80px] h-[80px] text-red-700" />
                </div>
                <div className="font-inter">
                  <h1 className="px-3 text-red-700 text-2xl text-center font-bold">
                    Academic Policies
          ...
          <div className="flex space-x-5 my-10">
            ...
            <div className="font-inter">
              ...
              <p className="text-black text-lg text-start">
                ...
                tradition of the Catholic faith. From 1951 -1956, the Religious
                of the Virgin Mary Sisters (RVM) laid the foundation upon which
                the school was founded. The Foreign Mission Society of Quebec
                (PME Fathers) from 1957 – 1976 strengthened and improved these
                structures. And the Archdiocese of Davao from 1976 up to the
                present, building on the traditions of its predecessors,
                expanded them to make the Holy Cross of Davao College a prime
                college in the city of Davao, providing affordable quality
                Catholic education not only to the people of the city but also
          ...
          <div className="flex space-x-5 my-10">
            <div className="font-inter">
              ...
              <p className="text-black text-lg text-end">
                ...
                ourselves to cultivate high quality Catholic education for all,
                attentive to the needs of the less fortunate; nurture a culture
                of excellence and holiness; and provide a human and Christian
                learning environment for the integral liberating formation of
                persons who will become effective agents of social
                transformation.
